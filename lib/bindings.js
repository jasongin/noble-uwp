...
NobleBindings.prototype.discoverDescriptors =
	...
	this._getCachedCharacteristicAsync(
		...
		debug('failed to get GAT characteristic descriptors for device %s: %s', deviceUuid, ex.stack);
...
NobleBindings.prototype.readValue =
	...
	return this._getCachedDescriptorAsync(
		...
		debug('failed to read GAT characteristic descriptor values for device %s: %s', deviceUuid,
			ex.stack);
